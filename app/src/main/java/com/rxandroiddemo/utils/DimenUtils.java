...
public class DimenUtils {
    ...
    public static int getScreenWidth() {
        return MyApp.getsInstance().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return MyApp.getsInstance().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * MyApp.getsInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / MyApp.getsInstance().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / MyApp.getsInstance().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * MyApp.getsInstance().getResources().getDisplayMetrics().scaledDensity;
    }
}
