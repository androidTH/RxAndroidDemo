...
public class LogUtils {
    ...
    private static String LOG_TAG = "RxAndroidDemo"; // 默认的tag
    ...
    public static void init(Context context) { // 在Application中初始化
        //sdcard/android/0/
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + MyApp.getsInstance().getPackageName();
        LOG_FILE_NAME = "Log";
    }
