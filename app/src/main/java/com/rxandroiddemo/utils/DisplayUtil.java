...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = MyApp.getsInstance().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = MyApp.getsInstance().getResources().getDisplayMetrics().scaledDensity;
