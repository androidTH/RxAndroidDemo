...
import com.rxandroiddemo.utils.GlideCircleTransfromUtil;
import com.rxandroiddemo.utils.GlideRoundTransformUtil;
import com.rxandroiddemo.utils.ImageLoaderUtils;
...
//        Glide.with(mContext).load(imgUrl).into(view);
        ImageLoaderUtils.display(mContext,view,imgUrl);
        return this;
    }
