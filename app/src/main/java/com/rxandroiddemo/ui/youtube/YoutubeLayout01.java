package com.rxandroiddemo.ui.youtube;
...
/**
 * @auther jjr
 * @date 创建时间： 2017/1/7 11:53
 * @Description
 */

public class YoutubeLayout01 extends ViewGroup {
    ...
    public YoutubeLayout01(Context context) {
        super(context);
        init(context);
    }

    public YoutubeLayout01(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public YoutubeLayout01(Context context, AttributeSet attrs, int defStyle) {
